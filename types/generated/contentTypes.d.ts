...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    MainImage: Schema.Attribute.Media<
      ...
      true
    >;
    ProveedorID: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFamiliaFamilia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visisbleEnMenu: Schema.Attribute.Boolean;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subfamilia: Schema.Attribute.String;
    tecnicaImpresion: Schema.Attribute.String;
    tecnicas: Schema.Attribute.Relation<
      'manyToMany',
      'api::tecnica-de-personalizacion.tecnica-de-personalizacion'
    >;
    TipoDePersonalizacion: Schema.Attribute.Enumeration<
      ['Grabado Laser', 'DTF UV', 'Bordado', 'Vinil']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTecnicaDePersonalizacionTecnicaDePersonalizacion
  extends Struct.CollectionTypeSchema {
  collectionName: 'tecnica_de_personalizacions';
  info: {
    displayName: 'tecnicas';
    pluralName: 'tecnica-de-personalizacions';
    singularName: 'tecnica-de-personalizacion';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tecnica-de-personalizacion.tecnica-de-personalizacion': ApiTecnicaDePersonalizacionTecnicaDePersonalizacion;
